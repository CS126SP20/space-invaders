...
class DebugDraw : public b2Draw {
 public:
  ...
  void setCenterOfMassEnabled(bool enable = true) {
    setFlagBit(enable, e_centerOfMassBit);
  }
  ...
  bool isCenterOfMassEnabled() const {
    return isFlagBitEnabled(e_centerOfMassBit);
  }
